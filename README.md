...
### Purpose
Using Excel data analysis tools detect trends visualizing campaign outcomes based on their launch dates, campaign outcome based their funding goals and deliver conclusions about the data trend.
